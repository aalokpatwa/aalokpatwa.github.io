...
export default function HomePage() {
    return (
        <div className="bg-white font-assistant flex flex-col">
            <div className="sm:max-w-5xl mx-auto pt-12 flex-1 flex flex-col">
                <div className="flex flex-col md:flex-row gap-16 py-8">
                    ...
                    <div className="md:w-2/3">
                        ...
                        <div className="space-y-4 text-gray-800 mt-8">
                                 ...
                                 I want to build <span className="font-semibold">AI models and systems that massively improve the human experience</span>.
                             </p>
                             <p className="text-lg leading-relaxed">
                 ...
                 <div className="mt-auto pt-8 pb-8 border-t border-gray-200">
